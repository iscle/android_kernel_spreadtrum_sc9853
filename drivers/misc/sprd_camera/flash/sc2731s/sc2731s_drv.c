...
err_i2c:
	...
	pr_info("sprd_flash_sc2731s_2705_ldo_cfg ret : %d\n", ret);
}
...
err_i2c:
	pr_info("sprd_flash_sc2731s_torch_2705_ldo_out ret : %d\n", ret);
}
...
static void sprd_flash_sc2731s_usb_plugin_ldo_set(bool plugin, int enable)
{
	...
	pr_info("sprd_flash_sc2731s_usb_plugin_ldo_set ret\n");
}
...
static void sprd_flash_sc2731s_flash_2705_ldo_out(int enable)
{
	...
	pr_info("sprd_flash_sc2731s_flash_2705_ldo_out ret\n");
}
