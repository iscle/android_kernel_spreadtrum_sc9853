...
enum sprd_iommu_type {
	...
	SPRD_IOMMU_R2P0,
	SPRD_IOMMU_R3P0,
	SPRD_IOMMU_R4P0, /*iwhale2*/
	SPRD_IOMMUPF_R1P0,/*dcam iommupf*/
	SPRD_IOMMUPF_R2P0,/*dispc iommupf*/
	SPRD_IOMMUEX_SHARKL2,
	SPRD_IOMMUEX_ISHARKL2,
	SPRD_IOMMUEX_SHARKLJ1,
...
struct sprd_iommu_init_param {
	...
	/*iommu hardware related*/
	u32 fullpage_mode;/* 1 means full page mode & prefetch mode
					coexist; 0 means only prefetch mode;*/
	...
	u8 fullch_read;/*channel number used for fullmode read,*/
	u8 fullch_write;/*channel number used for fullmode write,*/
