...
#define REG_AON_APB_WDG_RST_FLAG                    (0x3024)
#define REG_AON_APB_BOND_OPT0                       (0x303C)
#define REG_AON_APB_DEVICE_LIFE_CYCLE               (0x3040)
...
#define REG_AON_APB_DEBUG_FILTER_0                  (0x3090)
#define REG_AON_APB_DEBUG_FILTER_1                  (0x3094)
#define REG_AON_APB_DEBUG_FILTER_2                  (0x3098)
#define REG_AON_APB_DEBUG_FILTER_3                  (0x309C)
#define REG_AON_APB_DEBUG_FILTER_4                  (0x30A0)
#define REG_AON_APB_DEBUG_FILTER_5                  (0x30A4)
#define REG_AON_APB_LEAKAGE_MAGIC_WORD              (0x3100)
#define REG_AON_APB_LEAKAGE_SWITCH                  (0x3104)
#define REG_AON_APB_FUNC_TEST_BOOT_ADDR             (0x3110)
#define REG_AON_APB_CGM_RESCUE                      (0x3114)
#define REG_AON_APB_AON_SDIO                        (0x312C)
#define REG_AON_APB_SP_WAKEUP_MASK_EN0              (0x3184)
#define REG_AON_APB_SP_WAKEUP_MASK_EN1              (0x3188)
#define REG_AON_APB_SP_WAKEUP_MASK_EN2              (0x318C)
#define REG_AON_APB_DBG_BUS_DATA_WTLCP              (0x3190)
#define REG_AON_APB_DBG_BUS_DATA_PUBCP              (0x3194)
#define REG_AON_APB_DBG_BUS_DATA_AUDCP              (0x3198)
#define REG_AON_APB_SCC_DBG_BUS                     (0x3200)
#define REG_AON_APB_AON_FUNC_CTRL_0                 (0x3204)
#define REG_AON_APB_AON_FUNC_CTRL_1                 (0x3208)
...
#define BIT_AON_APB_ESE_EB                                      BIT(14)
...
#define BIT_AON_APB_ESE_SOFT_RST                                BIT(14)
