...
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AAPC_TEST_0           (0x0044)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_WRAP_GLUE_CTRL        (0x0048)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AAPC_TEST_1           (0x004C)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AAPC_TEST_2           (0x0050)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AAPC_TEST_3           (0x0054)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AAPC_TEST_4           (0x0058)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_PROBE_CAL             (0x005C)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AUX0_CAL              (0x0060)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AUX1_CAL              (0x0064)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AUX2_CAL              (0x0068)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_PLL_FREQ_CAL_CFG      (0x006C)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_PROBE_RESULT          (0x0070)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AUX0_RESULT           (0x0074)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AUX1_RESULT           (0x0078)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_AUX2_RESULT           (0x007C)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_PLL_TEST_FLAG         (0x0080)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_ISPPLL_CTRL0          (0x0084)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_REG_SEL_CFG_0         (0x0088)
#define REG_ANLG_PHY_G5_ANALOG_BB_TOP_REG_SEL_CFG_1         (0x008C)
#define REG_ANLG_PHY_G5_ANALOG_THM1_THM1_CTL                (0x0090)
#define REG_ANLG_PHY_G5_ANALOG_THM1_THM1_RESERVED_CTL       (0x0094)
#define REG_ANLG_PHY_G5_ANALOG_THM1_WRAP_GLUE_CTRL          (0x0098)
#define REG_ANLG_PHY_G5_ANALOG_THM1_REG_SEL_CFG_0           (0x009C)
#define REG_ANLG_PHY_G5_ANALOG_RPLL_SEL                     (0x00A0)
#define REG_ANLG_PHY_G5_ANALOG_AAPC_RAMP_GEN_SEL            (0x00A4)
