...
struct dispc_core_ops {
	...
	void (*disable_vsync)(struct dispc_context *ctx);
	void (*enable_vsync)(struct dispc_context *ctx);
...
extern unsigned int flag_mask_refresh;
extern struct sprd_adf_hwlayer *hwlayer_lastest;
