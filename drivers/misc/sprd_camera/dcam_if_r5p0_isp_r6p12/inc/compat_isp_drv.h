...
#define compat_isp_trace               pr_err
#define compat_isp_trace_high          pr_err
#else
#define compat_isp_trace(fmt, ...)
#define compat_isp_trace_high(fmt, ...)
#endif
...
extern const char *cam_ioctl_str[];
extern const int cam_ioctl_val[];
