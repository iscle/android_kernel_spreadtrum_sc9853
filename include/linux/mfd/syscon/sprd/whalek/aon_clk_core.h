...
#define REG_AON_CLK_CORE_CGM_WCDMA_CFG            (0x00F0)
#define REG_AON_CLK_CORE_CGM_AP_AXI_CFG           (0x00F4)
#define REG_AON_CLK_CORE_CGM_AP_MM_CFG            (0x00F8)
#define REG_AON_CLK_CORE_CGM_SDIO2_2X_CFG         (0x00FC)
#define REG_AON_CLK_CORE_CGM_SDIO2_1X_CFG         (0x0100)
#define REG_AON_CLK_CORE_CGM_ANALOG_IO_APB_CFG    (0x0104)
#define REG_AON_CLK_CORE_CGM_DMC_REF_CFG          (0x0108)
#define REG_AON_CLK_CORE_CGM_USB20_SCAN_ONLY_CFG  (0x010C)
#define REG_AON_CLK_CORE_CGM_EMC_CFG              (0x0110)
#define REG_AON_CLK_CORE_CGM_USB_CFG              (0x0114)
#define REG_AON_CLK_CORE_CGM_EFUSE_ESE_CFG        (0x0118)
#define REG_AON_CLK_CORE_CGM_AAPC_TEST_CFG        (0x011C)
