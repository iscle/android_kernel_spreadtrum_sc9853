...
u32 sprd_iommudrv_init(
				struct sprd_iommu_init_param *p_init_param ,
				sprd_iommu_hdl *p_iommu_hdl)
{
	...
	if ((SPRD_IOMMU_R1P0 == p_init_param->iommu_type)
		|| (SPRD_IOMMU_R2P0 == p_init_param->iommu_type)
		|| (p_init_param->iommu_type == SPRD_IOMMU_R3P0)
		|| (p_init_param->iommu_type == SPRD_IOMMU_R4P0)) {
			func_tbl = (&iommu_func_tbl);
		} else if ((SPRD_IOMMUPF_R1P0 == p_init_param->iommu_type)
			|| (SPRD_IOMMUPF_R2P0 == p_init_param->iommu_type)) {
			func_tbl = (&iommupf_func_tbl);
		} else if (p_init_param->iommu_type == SPRD_IOMMUEX_SHARKL2
			|| p_init_param->iommu_type == SPRD_IOMMUEX_SHARKLE
			|| p_init_param->iommu_type == SPRD_IOMMUEX_PIKE2
			|| p_init_param->iommu_type == SPRD_IOMMUEX_SHARKL3
			|| p_init_param->iommu_type == SPRD_IOMMUEX_ISHARKL2) {
...
u32 sprd_iommudrv_unmap_orphaned(
			sprd_iommu_hdl p_iommu_hdl,
			struct sprd_iommu_unmap_param *p_unmap_param)
{
	struct sprd_iommu_widget *p_iommu_data = NULL;
