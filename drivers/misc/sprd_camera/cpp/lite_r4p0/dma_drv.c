...
static void cpp_dma_dev_enable(struct dma_drv_private *p)
{
...
static void cpp_dma_dev_disable(struct dma_drv_private *p)
{
	unsigned long flags = 0;
...
static void cpp_dma_dev_start(struct dma_drv_private *p)
{
	unsigned long flags = 0;
...
static void cpp_dma_dev_stop(struct dma_drv_private *p)
{
	unsigned long flags = 0;
			...
			struct dma_drv_private *p)
{
	...
	pr_info("iommu_dma_src:0x%x\n", p->dma_dst_addr);
	pr_info("iommu_dma_dst:0x%x\n", p->dma_src_addr);
