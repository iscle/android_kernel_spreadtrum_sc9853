	...
	struct isp_k_block *isp_k_param, uint32_t idx)
{
	...
	ISP_REG_WR(idx, ISP_FETCH_SLICE_Y_PITCH, (fetch_info.pitch[0] & 0xFFFF));

	ISP_REG_WR(idx, ISP_FETCH_SLICE_U_PITCH, (fetch_info.pitch[1] & 0xFFFF));

	ISP_REG_WR(idx, ISP_FETCH_SLICE_V_PITCH, (fetch_info.pitch[2] & 0xFFFF));
